...
class NetworkPacketMonitor:
    ...
    def start(self):
        print(
            f"    📡 [WIFI] Activating LIVE Network Packet Sniffer on {self.interface}..."
        )
        self.running = True
    ...
    def _sniff_traffic(self):
        try:
            ...
            print(
                f"[!] Wifi Sniffing Error: You may need root/sudo privileges to capture raw packets. Details: {e}"
            )
    ...
    def _parse_packet(self, packet):
        try:
            ...
            if eth_protocol == 8:
                ...
                self.loop.call_soon_threadsafe(self._enqueue, log_content)
        except Exception as e:
